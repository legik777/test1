    ...
    <div class="h-screen w-screen bg-gray-100 flex items-center">
        <div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
            <div class="max-w-md">
                ...
                <p class="text-2xl md:text-3xl font-light leading-normal">К сожалению, мы не смогли найти эту страницу.</p>
                <p class="mb-8">Но не волнуйтесь, вы можете найти много других вещей на нашей домашней странице.</p>
                <router-link :to="{name:'main'}" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue q-return-button">вернуться на домашнюю страницу</router-link>
            </div>
            <div class="max-w-lg">
